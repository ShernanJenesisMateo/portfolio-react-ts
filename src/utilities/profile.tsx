export const author = {
    name: 'Shernan Jenesis Mateo',
    email: 'shernanjenesismateo0@gmail.com',
    contact: '0956-920-2747',
};
...
export const tools = [
    {
        category: "Frontend",
        items: [
            { img: "path/to/react.png", name: "React" },
            { img: "path/to/js.png", name: "JS" },
            { img: "path/to/tailwind.png", name: "Tailwind" },
        ],
    },
    {
        category: "Backend",
        items: [
            { img: "path/to/java.png", name: "Java" },
            { img: "path/to/python.png", name: "Python" },
            { img: "path/to/cpp.png", name: "C++" },
        ],
    },
    {
        category: "Database",
        items: [
            { img: "path/to/postgresql.png", name: "PostgreSQL" },
            { img: "path/to/mysql.png", name: "MySQL" },
        ],
    },
];
