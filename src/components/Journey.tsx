                    ...
                    {milestones.map((milestone, index) => (
                        <li key={index}>
                            ...
                            <div className={`${milestone.position} mb-10`}>
                                ...
                                <a href={milestone.link} target="_blank" rel="noopener noreferrer"><div className="text-lg font-black"><span className="underline-animation">{milestone.title}</span></div></a>
