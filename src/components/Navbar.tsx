      ...
      <div className="navbar bg-base/30 backdrop-blur-xl">
        <div className="navbar">
          <div className="flex-1 px-5">
            <a className="btn btn-ghost text-2xl font-mysignature" href='#HeroSectionId' onClick={(e) => { e.preventDefault(); scrollToSection('#HeroSectionId'); }}>
              {author.name}
            </a>
          </div>
          <div className="flex-none px-5">
            <ul className="menu menu-horizontal flex gap-5 items-center font-semibold">
              <li>
                <a href='#AboutSectionId' onClick={(e) => { e.preventDefault(); scrollToSection('#AboutSectionId'); }}>
                  About
                </a>
              </li>
              <li>
                <a href='#JourneySectionId' onClick={(e) => { e.preventDefault(); scrollToSection('#JourneySectionId'); }}>
                  Journey
                </a>
              </li>
              <li>
                <a href='#ProjectsSectionId' onClick={(e) => { e.preventDefault(); scrollToSection('#ProjectsSectionId'); }}>
                  Projects
                </a>
              </li>
              <li>
                <a href='#FooterSectionId' onClick={(e) => { e.preventDefault(); scrollToSection('#FooterSectionId'); }}>
                  Contact
                </a>
              </li>
